...
1. `npm start` to start local server
	- view at `http://localhost:2368`
	- view admin panel at `http://localhost:2368/ghost/`
1. Sign in using account: 
	- email: amooreinteractive@gmail.com
	- password: see slack channel #html-devs



---Default Ghost README---
